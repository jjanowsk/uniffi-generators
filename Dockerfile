...
RUN cargo install uniffi-bindgen-cs --tag v0.2.3+v0.23.0 --git https://github.com/jjanowsk/uniffi-bindgen-cs
RUN cargo install uniffi-bindgen-go --tag v0.1.1+v0.23.0 --git https://github.com/jjanowsk/uniffi-bindgen-go
